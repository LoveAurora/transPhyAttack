...
from YoloV3.nets.yolov3 import YoloBody
...
class YOLO(object):
    ...
    def generate(self):
        ...
        self.model_path = self.config.weightfile
        state_dict = torch.load(self.model_path, map_location=device)  # self.model_path
        ...
        self.multi_attention = attention.Attention(self.net, ori_shape=self._defaults["model_image_size"],
                                                   final_shape=self._defaults["model_image_size"],
                                                   yolo_decodes=self.yolo_decodes,
                                                   num_classes=self.num_classes,
                                                   conf_thres=self._defaults["confidence"],
